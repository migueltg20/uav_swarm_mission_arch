#ifndef BEHAVIOUR_PKG__LAND_BH_SERVER_HPP_
#define BEHAVIOUR_PKG__LAND_BH_SERVER_HPP_
...
protected:
    bool on_activate(std::shared_ptr<const LandBh::Goal> goal) override;
    bool on_modify(std::shared_ptr<const LandBh::Goal> goal) override;
...
private:
    ...
    std::array<float, 4> initial_height_;
    std::array<bool, 4> initial_height_set_;
    ...
    static constexpr float land_threshold_ = 0.1;
};

#endif  // BEHAVIOUR_PKG__LAND_BH_SERVER_HPP_